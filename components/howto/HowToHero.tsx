...
export default function HowToHero({
  ...
  return (
    <section className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-bg-base/70 p-5 shadow-[0_35px_120px_rgba(0,0,0,.45)] backdrop-blur-xl sm:p-7 md:p-10 lg:p-12">
      ...
      <div className="relative">
        ...
        <h1 className="mt-7 max-w-5xl font-display text-3xl font-black leading-tight tracking-tight text-text-primary sm:text-4xl md:text-5xl lg:text-6xl">
          {item.hero?.title || item.title}
        </h1>

        <p className="mt-6 max-w-3xl text-base leading-7 text-silver sm:text-lg sm:leading-8">
