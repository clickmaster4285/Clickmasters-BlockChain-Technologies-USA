...
export default function NewsCTA({
  title = "Need help applying this news to your business?",
  description = "Talk with ClickMasters and understand how this blockchain update affects your product, roadmap, or investment decision.",
  cta,
  compact = false,
}: {
  title?: string;
