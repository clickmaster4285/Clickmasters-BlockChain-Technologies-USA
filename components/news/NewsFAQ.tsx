...
export default function NewsFAQ({ item }: { item: any }) {
  ...
  return (
    <section className="mt-10 overflow-hidden rounded-[2.2rem] border border-white/10 bg-surface/80 shadow-[0_24px_80px_rgba(0,0,0,0.25)]">
      {/* Header */}
      <div className="relative border-b border-white/10 bg-gradient-to-r from-amber-base/15 via-white/[0.03] to-transparent p-6 md:p-10">
        <div className="absolute -right-16 -top-16 h-40 w-40 rounded-full bg-amber-base/15 blur-3xl" />

        <div className="relative flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
          <div className="flex items-start gap-4">
            <span className="grid h-14 w-14 place-items-center rounded-2xl border border-amber-base/20 bg-amber-base/10 text-amber-base">
            ...
            <div>
              ...
              <p className="mt-4 max-w-3xl text-sm leading-7 text-silver md:text-base">
                Everything you should know about this blockchain news update,
            ...
            <div className="flex gap-4">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <span className="hidden h-8 w-8 place-items-center rounded-full border border-white/10 text-amber-base transition-transform group-hover:rotate-45 md:grid">
