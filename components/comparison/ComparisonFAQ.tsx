...
export default function ComparisonFAQ({ article }: { article: any }) {
  ...
  return (
    <section className="mt-10 overflow-hidden rounded-[2.2rem] border border-white/10 bg-surface/80 shadow-[0_24px_80px_rgba(0,0,0,0.25)]">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-4 max-w-3xl text-sm leading-7 text-silver md:text-base">
                Clear answers to the most common technical, business, and
                implementation questions around this comparison.
              </p>
            </div>
          </div>
      ...
      <div className="grid gap-4 p-6 md:p-10">
        {article.faqs.map((item: any, index: number) => (
          <div
            key={item.question}
          ...
          >
            <div className="flex gap-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-5 h-px w-full bg-gradient-to-r from-amber-base/30 via-white/10 to-transparent opacity-0 transition-opacity group-hover:opacity-100" />
              </div>
            </div>
          </div>
        ))}
