...
import servicesBg from "@/assets/media/services-bg.jpg.asset.json";
...
export function Services() {
  ...
  return (
    <section id="services" className="dark relative overflow-hidden py-24 text-foreground md:py-32" style={{ background: "#0D1117" }}>
      <img src={servicesBg.url} alt="" aria-hidden="true" className="pointer-events-none absolute inset-0 h-full w-full object-cover opacity-20" />
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-[#0D1117]/80 via-[#0D1117]/70 to-[#0D1117]/90" />
      ...
      <div className="container relative mx-auto max-w-7xl px-6">
        <div className="mx-auto max-w-3xl text-center">
          <p className="font-mono text-xs uppercase tracking-[0.3em] text-[#00E5FF]">/ Services</p>
          ...
          {blockchainServices.map((s) => {
            ...
            return (
              ...
              >
                ...
                <a
                  href="#contact"
                  className="mt-6 inline-flex items-center gap-1 text-sm font-semibold text-[#00E5FF] opacity-0 transition-opacity group-hover:opacity-100"
                >
