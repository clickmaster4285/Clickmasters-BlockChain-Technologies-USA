...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Tell us about your DeFi, NFT, DAO or Web3 project. Senior blockchain engineers reply within 24 hours with a scoped plan." },
      { property: "og:title", content: "Contact ClickMasters — Build Your Web3 Project" },
      { property: "og:description", content: "Free 30-min consultation. Email, phone or WhatsApp our blockchain team today." },
    ],
  }),
