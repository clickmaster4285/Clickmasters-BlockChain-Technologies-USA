/**
 * Conversion Script: Glossary MD → Data File
 * Self-contained. Usage: node scripts/convert-glossary.cjs
 */
const fs = require('fs'), path = require('path');
const MD = path.join(__dirname, '..', 'md', 'glossary');
...
return{slug:sl,meta,sections:SS(c),faq:FA(c),ctas:CT(c),tags:TG(c,meta),category:'glossary'};}

console.log('Converting md/glossary/ → data/glossary.js\n');
...
fs.writeFileSync(OUT,o,'utf-8');console.log(`  ✅ Written to data/glossary.js (${items.length} files)`);
