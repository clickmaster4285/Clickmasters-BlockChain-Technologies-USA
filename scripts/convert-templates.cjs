const fs=require('fs'),path=require('path');const MD=path.join(__dirname,'..','md','template_pages');const OUT=path.join(__dirname,'..','data','templates.js');
...
const o=`const templates=${JSON.stringify(items,null,2)};
